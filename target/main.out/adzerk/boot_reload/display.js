...
return (function (p__6956){
var vec__6957 = p__6956;
var attr = cljs.core.nth.call(null,vec__6957,(0),null);
var v = cljs.core.nth.call(null,vec__6957,(1),null);
...
var args6958 = [];
var len__6066__auto___6961 = arguments.length;
var i__6067__auto___6962 = (0);
while(true){
if((i__6067__auto___6962 < len__6066__auto___6961)){
args6958.push((arguments[i__6067__auto___6962]));

var G__6963 = (i__6067__auto___6962 + (1));
i__6067__auto___6962 = G__6963;
continue;
} else {
}
break;
...
var len__6066__auto___6966 = arguments.length;
var i__6067__auto___6967 = (0);
while(true){
if((i__6067__auto___6967 < len__6066__auto___6966)){
args__6073__auto__.push((arguments[i__6067__auto___6967]));

var G__6968 = (i__6067__auto___6967 + (1));
i__6067__auto___6967 = G__6968;
continue;
} else {
}
break;
...
var argseq__6074__auto__ = ((((0) < args__6073__auto__.length))?(new cljs.core.IndexedSeq(args__6073__auto__.slice((0)),(0))):null);
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__6074__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq6965){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq6965));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__6969){
var map__6973 = p__6969;
var map__6973__$1 = ((((!((map__6973 == null)))?((((map__6973.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6973.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6973):map__6973);
var data = map__6973__$1;
var message = cljs.core.get.call(null,map__6973__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__6973__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__6973__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__6975 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__6975,goog.events.EventType.CLICK,((function (G__6975,map__6973,map__6973__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__6975,map__6973,map__6973__$1,data,message,line,file))
);

return G__6975;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__6976){
var map__6980 = p__6976;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__6983){
var map__6987 = p__6983;
...
var messages = map__6987__$1;
var warnings = cljs.core.get.call(null,map__6987__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__6987__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__6989 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__6989,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__6989,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__6990){
var map__6993 = p__6990;
var map__6993__$1 = ((((!((map__6993 == null)))?((((map__6993.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6993.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6993):map__6993);
var messages = map__6993__$1;
var warnings = cljs.core.get.call(null,map__6993__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__6993__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__6993,map__6993__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__6993,map__6993__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__6993,map__6993__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__6993,map__6993__$1,messages,warnings,exception))
;
...
}catch (e6996){if((e6996 instanceof Error)){
var __6997 = e6996;
} else {
throw e6996;
